...
export default function Register() {
  ...
  return (
    <AuthLayout back={<BackLink to="/login">{t('auth_back_login')}</BackLink>}>
      <AuthCard
        eyebrow={t('auth_register_eyebrow')}
        title={t('auth_register_title')}
        subtitle={t('auth_register_subtitle')}
      >
        <div className={REG_TABS_CLS} role="list" aria-label={t('auth_register_type_aria')}>
          <Link to="/register/phone" className={REG_TAB_CLS} role="listitem">
            ...
            <span className={REG_TAB_LABEL_CLS}>{t('auth_register_phone')}</span>
            <span className={REG_TAB_SUB_CLS}>SMS · OTP</span>
          </Link>
          <span className={REG_TABS_DIVIDER_CLS} aria-hidden="true">
            {t('auth_or')}
          </span>
          <Link to="/register/email" className={REG_TAB_CLS} role="listitem">
            ...
            <span className={REG_TAB_LABEL_CLS}>{t('auth_register_email')}</span>
            <span className={REG_TAB_SUB_CLS}>Gmail · Outlook</span>
          </Link>
        </div>

        <Divider>{t('auth_or')}</Divider>
