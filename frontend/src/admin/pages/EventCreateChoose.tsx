    ...
    <>
      ...
      <div className="grid gap-4 max-w-[860px] [grid-template-columns:repeat(2,minmax(0,1fr))] max-[760px]:[grid-template-columns:1fr] max-[640px]:gap-3">
        ...
        <ChoiceCard
          ...
          desc="Цэнгэлдэх дээрх касс дээр гарч, таны тохируулсан төрлүүдээр тасалбар биечлэн зарагдана."
          bullets={[
            "Тоглолтын огноо ба эхлэх цаг",
            "Дурын тооны төрөл — нэрийг нь өөрөө өгнө",
      ...
      <p className="mt-4 text-[12.5px] text-zinc-500 max-w-[860px]">
        Вэб ба касс хоёр бүрэн тусдаа. Нэг тоглолтыг хоёуланд нь зарах бол тус
        бүрд нь тусад нь нэмнэ.
      </p>
    </>
  );
}
